...
class Matricula(models.Model):
	aluno = models.ForeignKey(Aluno)
	situacao = models.CharField(default="M", max_length=100)
	horas_faltadas = models.IntegerField(default=0)
...
class Turma(models.Model):
	...
	alunos_inscritos = models.ManyToManyField(Matricula, related_name='%(class)s_Aluno_inscrito')
	alunos_espera = models.ManyToManyField(Matricula, related_name='%(class)s_Aluno_espera')
	status = models.CharField('Status', max_length=25, choices = Status_escolhas, default = "Aberta")
